...
const NAV = [
  ...
  { section: "Eksplorasi" },
  { label: "WP&B Eksplorasi", href: "/dokumen/wpb-eksplorasi", icon: "·", sub: true },
  { label: "AFE Eksplorasi", href: "/dokumen/afe", icon: "·", sub: true },
  ...
  { label: "AFE Eksploitasi", href: "/dokumen/afe-eksploitasi", icon: "·", sub: true },
  { label: "Cadangan Migas", href: "/dokumen/cadangan", icon: "·", sub: true },
  { section: "Kelola" },
  { label: "Kontraktor", href: "/kkks", icon: "🏢" },
  { label: "Wilayah Kerja", href: "/wk", icon: "🗺" },
  { label: "Peta WK", href: "/peta", icon: "📍" },
