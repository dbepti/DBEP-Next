...
export default function WPBEksplorasi() {
  ...
  const COL = "180px 1fr 1fr 60px 90px";
  ...
  return (
    <div style={{ display:"flex", flexDirection:"column", height:"100%", background:"#1a1a1a", overflow:"hidden" }}>
      ...
      <div style={{ padding:"8px 16px", borderBottom:"1px solid #2a2a2a", background:"#212121", display:"flex", alignItems:"center", gap:8, flexWrap:"wrap", flexShrink:0 }}>
        <span style={{ fontSize:13, color:"#e0e0e0", fontWeight:500 }}>WP&B Eksplorasi</span>
        ...
        <input value={search} onChange={e=>setSearch(e.target.value)} placeholder="Cari judul..."
          style={{ background:"#2a2a2a", border:"1px solid #383838", borderRadius:5, padding:"5px 10px", color:"#e0e0e0", fontSize:11, width:160, outline:"none" }}/>
      ...
      <div style={{ flex:1, display:"flex", flexDirection:"column", overflow:"hidden" }}>
        ...
        {/* LIST — atas */}
        <div style={{ flex: selected?"0 0 55%":"1", display:"flex", flexDirection:"column", overflow:"hidden", borderBottom: selected?"1px solid #2a2a2a":"none" }}>
          {/* Header kolom */}
